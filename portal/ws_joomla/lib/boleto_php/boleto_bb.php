...
$valor_cobrado = $pedido_veterinario_regional->getPed_valor_total(); // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$dadosboleto["instrucoes1"] = "- Codigo do boleto: " . $_SESSION['ped_cod_boleto'];
...
$dadosboleto["quantidade"] = $pedido_veterinario_regional->getPed_quantidade();
$dadosboleto["valor_unitario"] = $pedido_veterinario_regional->getPed_valor_unitario();

...
<form name="adminForm" method="post" action="">
	...
	<input type="hidden" name="hide_joomla3_message" value="<?php echo $this->controller->fua_config['hide_joomla3_message']; ?>" />
...
if($value=='camper'){
   ...
   $groups = '14,67,38'; 
			...
			<tr>		
				<td>
					<?php echo JText::_('COM_FRONTENDUSERACCESS_ACCESS_TO_PAGES_NO_MENUITEMS'); ?>
				</td>
				<td colspan="2">
					<?php echo JText::_('COM_FRONTENDUSERACCESS_ACCESS_TO_PAGES_NO_MENUITEMS_INFO'); ?> '<?php echo JText::_('COM_FRONTENDUSERACCESS_COMPONENT_ACCESS'); ?>'.
					<br /><br />					
					<label>
						<input type="checkbox" class="checkbox" name="menu_allow_searchresults" value="true" <?php if($this->controller->fua_config['menu_allow_searchresults']){echo 'checked="checked"';} ?> /> 
						<?php echo $this->controller->fua_strtolower(JText::_('COM_LANGUAGES_VIEW_OVERRIDE_RESULTS_LEGEND')); ?> (com_search)
					</label>
				</td>				
			</tr>					
			<tr>

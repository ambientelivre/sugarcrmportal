...
<div style="width: 800px; text-align: left; background: url(components/com_frontenduseraccess/images/icon.png) 10px 0 no-repeat;">
	...
	<div style="width: 1000px; overflow: hidden;">	
		...
		<div style="width: 380px; float: left;">
			<p>
				Please note that Frontend-User-Access will not be rebuild for Joomla 3. You can use <a href="http://www.pages-and-items.com/extensions/access-manager" target="_blank">Access-Manager</a> instead.
			</p>
			<p>
			...
			<p>
				You can make as many usergroups as you need and assign users to them. <br />
				If you want to set rights using the Joomla usergroups or accesslevels (better integrated with other 3rd party extensions) use <a href="http://www.pages-and-items.com/extensions/access-manager" target="_blank">Access-Manager</a> instead.
				<br />
				<br />
				There are 2 predefined usergroups which are very userfull: 
				<ul>

...
class com_frontenduseraccessInstallerScript {
	...
	function preflight($type, $parent){
		...
		if($version->RELEASE >= '3.0'){
			$message = 'Frontend-User-Access is not for Joomla 3 and up. Use <a href="http://www.pages-and-items.com/extensions/access-manager" target="_blank">Access-Manager</a> instead. Please read this FAQ: <a href="http://www.pages-and-items.com/extensions/frontend-user-access/faqs?faqitem=install_joomla3" target="_blank">Frontend-User-Access for Joomla 3?</a>';			
...
mod_menu_override=
menu_allow_searchresults=1
hide_joomla3_message=
';
...
';		
			...
			//added in version 4.1.7
			if(!strpos($fua_config, 'menu_allow_searchresults')){	
				$updated_config .= '
menu_allow_searchresults=1
';		
				$config_needs_updating = 1;
			...
			//added in version 4.1.8
			if(!strpos($fua_config, 'hide_joomla3_message')){	
				$updated_config .= '
hide_joomla3_message=
';		
				$config_needs_updating = 1;
		...
		//clean index table after use of broken Payplans plugin	
		$database->setQuery("DELETE FROM #__fua_userindex WHERE group_id='\"\"' ");
		$database->query();		
	...
	function uninstall($installer){
		...
		$tables_to_drop[] = '#__fua_categories';
		$tables_to_drop[] = '#__fua_components';
		$tables_to_drop[] = '#__fua_config';
		$tables_to_drop[] = '#__fua_items';
		$tables_to_drop[] = '#__fua_menuaccess';
		$tables_to_drop[] = '#__fua_modules_two';
		$tables_to_drop[] = '#__fua_parts';
		$tables_to_drop[] = '#__fua_partsaccess';
		$tables_to_drop[] = '#__fua_usergroups';
		$tables_to_drop[] = '#__fua_userindex';		

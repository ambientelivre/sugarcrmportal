...
<form name="adminForm" id="adminForm" method="post" action="">
	...
	<div id="j-main-container"<?php echo empty($this->sidebar) ? '' : ' class="span10"'; ?>>
		...
		<fieldset class="adminform fieldset_margin_bottom">	
			<legend class="amm_legend"><?php echo JText::_('JFIELD_ACCESS_LABEL'); ?></legend>
		...
		<?php } ?>
		<fieldset class="adminform fieldset_margin_bottom">
			<legend class="amm_legend"><?php echo JText::_('COM_ADMINMENUMANAGER_MULTI').' '.JText::_('COM_INSTALLER_TYPE_TYPE_LANGUAGE'); ?></legend>	
			<table class="adminlist amm_table">																						
				<tr>		
					<td style="width: 230px;">
		...
		<fieldset class="adminform fieldset_margin_bottom">
			<legend class="amm_legend"><?php echo JText::_('JVERSION'); ?></legend>	
			<table class="adminlist amm_table">																						
				<tr>		
					<td style="width: 230px;">

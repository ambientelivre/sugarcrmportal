...
<form action="" method="post" name="adminForm" id="adminForm">
	...
	<div class="fltlft">
		...
		<fieldset class="adminform">
			<legend class="amm_legend"><?php echo JText::_('JGLOBAL_PREVIEW'); ?></legend>
			<table class="adminlist tabletop amm_table">
				<tr>					
		...
		<fieldset class="adminform">
			<legend class="amm_legend"><?php echo JText::_('COM_ADMINMENUMANAGER_QUICK_LINK_CREATOR'); ?></legend>
			<table class="adminlist tabletop amm_table">								
				<tr>					
		...
		<fieldset class="adminform">
			<legend class="amm_legend"><?php echo JText::_('COM_ADMINMENUMANAGER_CUSTOM_LINKS'); ?></legend>
			<table class="adminlist tabletop amm_table">
				<tr>

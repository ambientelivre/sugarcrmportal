	...
	function get_components(){
		...
		foreach($this->menu_items_filtered as $menu_item){
			...
			if($menu_item->level=='1'){
				$components_array_parents[] = array($menu_item->id, $menu_item->level, $menu_item->link, $menu_item->img, JText::_($menu_item->title), $menu_item->title);
			}else{
				$components_array_children[] = array($menu_item->id, $menu_item->level, $menu_item->link, $menu_item->img, JText::_($menu_item->title), $menu_item->parent_id, $menu_item->title);
			}
		}

...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=modulesbackend'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">		
							<tr>		
								...
								<td>
									<input type="checkbox" name="modulebackend_active" class="checkbox" value="true" <?php if($this->controller->am_config['modulebackend_active']){echo 'checked="checked"';} ?> />
								</td>
								<td><?php
							...
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="modulebackend_author_access" value="true" <?php if($this->controller->am_config['modulebackend_author_access']){echo 'checked="checked"';} ?> />
								</td>
								<td><?php

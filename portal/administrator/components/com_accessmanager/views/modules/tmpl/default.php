...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=modules'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">		
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="module_active" value="true" <?php if($this->controller->am_config['module_active']){echo 'checked="checked"';} ?> />
								</td>
								<td><?php

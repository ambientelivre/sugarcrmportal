...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=pluginsbackend'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="pluginbackend_active" value="true" <?php if($this->controller->am_config['pluginbackend_active']){echo 'checked="checked"';} ?> />
								</td>
								<td>

...
//script for submitbuttons. not sure if this is still needed.
...
<form name="adminForm" id="adminForm" method="post" action="">
	...
	<div style="margin: 0 auto; text-align: left;">	
		...
		<table class="adminlist am_table">				
			...
			<tr <?php if($this->helper->joomla_version < '3.0'){echo 'style="display: none;"';} ?>>		
				<td>
					<?php echo JText::_('COM_ACCESSMANAGER_MULTISELECT').' '.$this->controller->am_strtolower(JText::_('COM_TEMPLATES_HEADING_STYLE')); ?>
				</td>
				<td>
					<label style="white-space: nowrap;"><input type="radio" name="multiselector_bootstrap" id="bootstrap_no" value="0" class="radio" <?php if($this->controller->am_config['multiselector_bootstrap']=='0'){echo 'checked="checked"';} ?> /><?php echo JText::_('COM_ACCESSMANAGER_WITHOUT').' bootstrap'; ?></label>										
				</td>
				<td>
					<label for="bootstrap_no"><img src="components/com_accessmanager/images/bootstrap_no.jpg" alt="without bootstrap" /></label>					
				</td>
			</tr>
			<tr <?php if($this->helper->joomla_version < '3.0'){echo 'style="display: none;"';} ?>>				
				<td>
				...
				<td>					
					<label style="white-space: nowrap;"><input type="radio" name="multiselector_bootstrap" id="bootstrap_yes" value="1" class="radio" <?php if($this->controller->am_config['multiselector_bootstrap']=='1'){echo 'checked="checked"';} ?> /><?php echo JText::_('COM_ACCESSMANAGER_WITH').' bootstrap'; ?></label>					
				</td>
				<td>
					<label for="bootstrap_yes"><img src="components/com_accessmanager/images/bootstrap_yes.jpg" alt="without bootstrap" /></label>					
				</td>
			</tr>			
			...
			<tr>		
				...
				<td>
					<?php echo JText::_('COM_ACCESSMANAGER_MAXINPUT'); ?>.						
					<a href="http://www.pages-and-items.com/extensions/access-manager/faqs?faqitem=issues_limit_posts" target="_blank"><?php echo JText::_('COM_ACCESSMANAGER_READ_MORE'); ?></a>				
				</td>
			</tr>																								
			<tr>		
				<td>
			...
			<tr>		
				<td>
					<?php echo 'Joomla '.$this->controller->am_strtolower(JText::_('JLIB_INSTALLER_UPDATE')); ?>	
				</td>
				<td colspan="2">				
					<?php echo JText::_('COM_ACCESSMANAGER_UPDATER'); ?>.				
				</td>
			</tr>			
			<tr>		
				<td colspan="3">&nbsp;

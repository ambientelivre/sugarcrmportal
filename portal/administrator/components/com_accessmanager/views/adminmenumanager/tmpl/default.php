...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=adminmenumanager'); ?>">	
	...
	<div id="j-main-container"<?php echo empty($this->sidebar) ? '' : ' class="span10"'; ?>>
					...
					<table style="width: 100%;">
						<tr>
							<td>
								...
								$this->controller->reverse_access_warning('adminmenumanager_reverse_access');
		...
		foreach($this->items as $item){
			...
			echo '<td class="'.$has_superscript.' nowrap">';			
			$levels = $item->level;
			for($n = 1; $n < $levels; $n++){					

...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=components'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">
							<tr>		
								...
								<td>
									<input type="checkbox" name="component_active"  class="checkbox" value="true" <?php if($this->controller->am_config['component_active']){echo 'checked="checked"';} ?> />
								</td>
							...
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="component_superadmins" value="true" <?php if($this->controller->am_config['component_superadmins']){echo 'checked="checked"';} ?> />
								</td>
								<td>

...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=articles'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">					
							...
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="article_superadmins" value="true" <?php if($this->controller->am_config['article_superadmins']){echo 'checked="checked"';} ?> />
								</td>
								<td>
							...
							<tr>		
								...
								<td colspan="2">
									<?php			
										echo $this->helper->display_multigrouplevel_select_config('article', $this->controller->am_config, 1);				
									?>					

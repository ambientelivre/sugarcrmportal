...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=componentsbackend'); ?>">	
			...
			<tr>
				<td>	
					<p>
						...
						<?php echo JText::_('COM_ACCESSMANAGER_COMPONENTSBACKEND_INFO').'. <a href="http://www.pages-and-items.com/extensions/access-manager/faqs?faqitem=config_component_access_backend" target="_blank">'.JText::_('COM_ACCESSMANAGER_DOES_NOT_OVERRIDE').' Joomla</a>. '.JText::_('COM_ACCESSMANAGER_CB_ONLY_RESTRICTS_ACCESS').' Joomla ACL '.JText::_('COM_ACCESSMANAGER_GROUP_NEEDS_ACCESS').' Joomla, Access-Manager '.JText::_('COM_ACCESSMANAGER_GROUP_NEEDS_ACCESS_B').'. '.JText::_('COM_ACCESSMANAGER_DISPLAYED_ONLY_BACKEND_GROUPS'); ?>.
					...
					<div class="border_bottom">
						<table class="adminlist am_table">	
							<tr>		
								...
								<td>
									<input type="checkbox" name="componentbackend_active" class="checkbox" value="true" <?php if($this->controller->am_config['componentbackend_active']){echo 'checked="checked"';} ?> />
								</td>

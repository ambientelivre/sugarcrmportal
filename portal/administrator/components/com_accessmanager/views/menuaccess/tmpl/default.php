...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=menuaccess'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">
							<tr>		
								...
								<td>
									<input type="checkbox"  class="checkbox" name="menuitem_active" value="true" <?php if($this->controller->am_config['menuitem_active']){echo 'checked="checked"';} ?> />
								</td>
								<td>
								<?php 
									...
									<br /><br />
									<label>
										<input type="checkbox"  class="checkbox" name="menumodule_override" value="true" <?php if($this->controller->am_config['menumodule_override']){echo 'checked="checked"';} ?> />
										<?php
											echo JText::_('COM_ACCESSMANAGER_MENUMODULE_OVERRIDE');
										?>.
									</label>
									<br /><br />
									<?php
							...
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="menuitem_superadmins" value="true" <?php if($this->controller->am_config['menuitem_superadmins']){echo 'checked="checked"';} ?> />
								</td>
								<td>
							...
							<tr>		
								...
								<td colspan="2">
									<?php			
										echo $this->helper->display_multigrouplevel_select_config('menuitem', $this->controller->am_config, 1);				
									?>					

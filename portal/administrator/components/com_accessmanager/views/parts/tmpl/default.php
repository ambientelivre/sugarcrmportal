...
<form name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_accessmanager&view=parts'); ?>">	
					...
					<div class="border_bottom">
						<table class="adminlist am_table">	
							<tr>		
								...
								<td>
									<input type="checkbox" name="part_active" class="checkbox" value="true" <?php if($this->controller->am_config['part_active']){echo 'checked="checked"';} ?> />
								</td>
								<td>&nbsp;
								</td>
							</tr>
							...
							<tr>		
								...
								<td>
									<input type="checkbox" class="checkbox" name="part_superadmins" value="true" <?php if($this->controller->am_config['part_superadmins']){echo 'checked="checked"';} ?> />
								</td>
								<td>
		...
		<table class="adminlist table table-striped" style="width: 100%;">
			...
			<?php
				...
				foreach($this->items as $part){	
					...
					if($part->description!=''){
						echo '<label class="hasTip" title="'.htmlspecialchars($part->name).'::'.htmlspecialchars($part->description).'">';
					}			
					echo $part->name;
					if($part->description!=''){
						echo '</label>';

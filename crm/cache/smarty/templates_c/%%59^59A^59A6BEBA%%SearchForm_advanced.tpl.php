<?php /* Smarty version 2.6.11, created on 2014-12-15 14:57:56
         compiled from cache/modules/Contacts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Contacts/SearchForm_advanced.tpl', 4, false),array('function', 'math', 'cache/modules/Contacts/SearchForm_advanced.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/Contacts/SearchForm_advanced.tpl', 14, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/SearchForm_advanced.tpl', 175, false),array('function', 'html_options', 'cache/modules/Contacts/SearchForm_advanced.tpl', 247, false),)), $this); ?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Contacts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'Contacts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_ADDRESS','module' => 'Contacts'), $this);?>
...
"  class="sqsEnabled" tabindex="" id="<?php echo $this->_tpl_vars['fields']['account_name_advanced']['name']; ?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_account_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_account_name_advanced","account_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_report_to_name_advanced\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["report_to_name_advanced","reports_to_id_advanced","reports_to_id_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_campaign_name_advanced\']={"form":"search_form","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_name_advanced","campaign_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};</script>'; ?>
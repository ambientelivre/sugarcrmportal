<?php /* Smarty version 2.6.11, created on 2014-12-09 15:11:18
         compiled from cache/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/DetailView.tpl', 29, false),array('function', 'counter', 'cache/modules/Accounts/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Accounts/DetailView.tpl', 35, false),array('function', 'sugar_phone', 'cache/modules/Accounts/DetailView.tpl', 73, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/DetailView.tpl', 45, false),array('modifier', 'substr', 'cache/modules/Accounts/DetailView.tpl', 195, false),array('modifier', 'to_url', 'cache/modules/Accounts/DetailView.tpl', 197, false),array('modifier', 'escape', 'cache/modules/Accounts/DetailView.tpl', 242, false),array('modifier', 'url2html', 'cache/modules/Accounts/DetailView.tpl', 242, false),array('modifier', 'nl2br', 'cache/modules/Accounts/DetailView.tpl', 242, false),array('modifier', 'strip_tags', 'cache/modules/Accounts/DetailView.tpl', 247, false),)), $this); ?>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['razao_social_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_RAZAO_SOCIAL','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['razao_social_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['razao_social_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['razao_social_c']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['inscricao_estadual_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['inscricao_estadual_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['inscricao_estadual_c']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['cnpj_cpf_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CNPJ_CPF','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['cnpj_cpf_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['cnpj_cpf_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['cnpj_cpf_c']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['tipo_conte_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TIPO_CONTE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['tipo_conte_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['tipo_conte_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['tipo_conte_c']['options'][$this->_tpl_vars['fields']['tipo_conte_c']['value']]; ?>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['a__retorno__accounts_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_A__RETORNO_DE_INVESTIMENTO_ACCOUNTS_FROM_A__RETORNO_DE_INVESTIMENTO_TITLE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['a__retorno__accounts_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['a__retorno7b64timento_ida']['value'] )): ?><a href="index.php?module=A__Retorno_de_investimento&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['a__retorno7b64timento_ida']['value']; ?>
"><?php endif; ?>
<span id="a__retorno7b64timento_ida" class="sugar_field"><?php echo $this->_tpl_vars['fields']['a__retorno__accounts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['a__retorno7b64timento_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['opportuniti_accounts_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITIES_ACCOUNTS_FROM_OPPORTUNITIES_TITLE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['opportuniti_accounts_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['opportunit9c8cunities_ida']['value'] )): ?><a href="index.php?module=Opportunities&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['opportunit9c8cunities_ida']['value']; ?>
"><?php endif; ?>
<span id="opportunit9c8cunities_ida" class="sugar_field"><?php echo $this->_tpl_vars['fields']['opportuniti_accounts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['opportunit9c8cunities_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>

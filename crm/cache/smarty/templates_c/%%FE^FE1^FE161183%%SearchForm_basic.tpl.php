<?php /* Smarty version 2.6.11, created on 2015-02-06 12:23:17
         compiled from cache/modules/ant_cliente/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 10, false),array('function', 'math', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 11, false),array('function', 'sugar_translate', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 21, false),array('function', 'html_options', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 81, false),array('function', 'sugar_getimagepath', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 123, false),array('modifier', 'count', 'cache/modules/ant_cliente/SearchForm_basic.tpl', 110, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['cli_razao_social_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['cli_razao_social_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['cli_razao_social_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cli_razao_social_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['cli_razao_social_basic']['name']; ?>
' size='30' 
    maxlength='255' 
...
<?php if (strlen ( $this->_tpl_vars['fields']['cli_nm_fantasia_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['cli_nm_fantasia_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['cli_nm_fantasia_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cli_nm_fantasia_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['cli_nm_fantasia_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
...
<?php echo smarty_function_html_options(array('name' => 'cli_estado_basic[]','options' => $this->_tpl_vars['fields']['cli_estado_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['cli_estado_basic']['value']), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['cli_cidade_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['cli_cidade_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['cli_cidade_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cli_cidade_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['cli_cidade_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 

<?php /* Smarty version 2.6.11, created on 2012-03-25 20:10:17
         compiled from modules/Campaigns/WizardMarketing.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Campaigns/WizardMarketing.html', 123, false),)), $this); ?>
<!--
/*********************************************************************************
...
<tr><td scope='row'><div id='nav_step3'><a  href='<?php echo $this->_tpl_vars['CAMP_WIZ_URL']; ?>
1'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_GEN1']; ?>
</a></div></td></tr>
<tr><td scope='row'><div id='nav_step4'><a  href='<?php echo $this->_tpl_vars['CAMP_WIZ_URL']; ?>
2'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_GEN2']; ?>
</a></div></td></tr>
<tr><td scope='row'><div id='nav_step5'><a  href='<?php echo $this->_tpl_vars['CAMP_WIZ_URL']; ?>
3'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_TRACKERS']; ?>
</a></div></td></tr>
<tr><td scope='row'><div id='nav_step6'><a  href='<?php echo $this->_tpl_vars['CAMP_WIZ_URL']; ?>
4'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SUBSCRIPTIONS']; ?>
</a></div></td></tr>
<tr><td scope='row'><div id='nav_step1'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_MARKETING']; ?>
</div></td></tr>
<tr><td scope='row'><div  id='nav_step2'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SEND_EMAIL']; ?>
</div></td></tr>
<tr><td scope='row'><div id='nav_step7'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SUMMARY']; ?>
</div></td></tr>
</table>
</div>
</td>
...
<br></td><td>&nbsp;</td></tr>
		...
		<tr>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_MRKT_NAME']; ?>
...
"></slot></td>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_STATUS_TEXT']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
...
' name='wiz_step3_status'><?php echo $this->_tpl_vars['STATUS_OPTIONS']; ?>
		...
		<tr>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_FROM_MAILBOX_NAME']; ?>
<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
...
' id='inbound_email_id' name='wiz_step3_inbound_email_id' onchange='set_from_reply_info(this);'><?php echo $this->_tpl_vars['MAILBOXES']; ?>
			...
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_START_DATE_TIME']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
...
"/><?php echo $this->_tpl_vars['TIME_MERIDIEM']; ?>
		...
		<tr>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_FROM_NAME']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
...
"></slot></td>
			...
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_FROM_ADDR']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
...
"></slot></td>
		...
		<tr>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_REPLY_NAME']; ?>
</slot></td>
...
"></slot></td>
			...
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_REPLY_ADDR']; ?>
</slot></td>
...
"></slot></td>
		...
		<tr>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_MESSAGE_FOR']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
 ...
 name='all_prospect_lists'><?php echo $this->_tpl_vars['MOD']['LBL_ALL_PROSPECT_LISTS']; ?>
</slot></td>
			<td scope="row" NOWRAP valign="top"><slot><?php echo $this->_tpl_vars['MOD']['LBL_TEMPLATE']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></slot></td>
			<td class="datafield" nowrap>
					<select  id="template_id" name='template_id' tabindex='2' onchange="show_edit_template_link(this);"><?php echo $this->_tpl_vars['EMAIL_TEMPLATE_OPTIONS']; ?>
</select>
...
'>
  ...
  tabindex='1' multiple size="5" id="message_for" name='message_for[]'><?php echo $this->_tpl_vars['SCOPE_OPTIONS']; ?>
</select></slot></td>
			<td scope="row" NOWRAP valign="top"><slot>&nbsp;</slot></td>
			<td><slot>&nbsp;</slot></td>
		</tr>
...
<br></td></tr>
			...
			<tr><td>
				<input type="radio"  id="next_step" name="wiz_home_next_step" value='1'checked ><?php echo $this->_tpl_vars['MOD']['LBL_SAVE_EXIT_BUTTON_LABEL']; ?>

			</td></tr>
			<tr><td>
				&nbsp;<div id='target_message'><font color='red'><b><?php echo $this->_tpl_vars['WARNING_MESSAGE']; ?>
</b></font></div>
				&nbsp;<div id='send_email1' ><input type="radio"  id="next_step" name="wiz_home_next_step" value='2' <?php echo $this->_tpl_vars['PL_DISABLED']; ?>
><?php echo $this->_tpl_vars['MOD']['LBL_SEND_AS_TEST']; ?>
</div>
			</td></tr>
			<tr><td>
				&nbsp;<div id='send_email2' <?php echo $this->_tpl_vars['SHOW_DIVS']; ?>
><input type="radio"  id="next_step" name='wiz_home_next_step' value='3' <?php echo $this->_tpl_vars['PL_DISABLED']; ?>

<?php /* Smarty version 2.6.11, created on 2015-03-18 16:35:21
         compiled from cache/modules/ant_estoque_geral/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ant_estoque_geral/SearchForm_basic.tpl', 10, false),array('function', 'math', 'cache/modules/ant_estoque_geral/SearchForm_basic.tpl', 11, false),array('function', 'sugar_translate', 'cache/modules/ant_estoque_geral/SearchForm_basic.tpl', 21, false),array('function', 'sugar_getimagepath', 'cache/modules/ant_estoque_geral/SearchForm_basic.tpl', 50, false),array('modifier', 'count', 'cache/modules/ant_estoque_geral/SearchForm_basic.tpl', 37, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EG_LOTE','module' => 'ant_estoque_geral'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['eg_lote_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['eg_lote_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['eg_lote_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['eg_lote_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['eg_lote_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='Lote do produto' tabindex='' > 
   	   	</td>

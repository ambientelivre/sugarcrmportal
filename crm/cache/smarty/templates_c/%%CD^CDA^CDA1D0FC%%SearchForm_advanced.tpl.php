<?php /* Smarty version 2.6.11, created on 2015-02-25 09:47:19
         compiled from cache/modules/Calls/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Calls/SearchForm_advanced.tpl', 4, false),array('function', 'math', 'cache/modules/Calls/SearchForm_advanced.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/Calls/SearchForm_advanced.tpl', 14, false),array('function', 'html_options', 'cache/modules/Calls/SearchForm_advanced.tpl', 47, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/SearchForm_advanced.tpl', 58, false),)), $this); ?>
...
<select name='parent_type' tabindex="" id='parent_type' title='' 
...
.value="";document.search_form.parent_id.value=""; 
	parent_typechangeQS(); checkParentType(document.search_form.parent_type.value, document.search_form.btn_<?php echo $this->_tpl_vars['fields']['parent_name_advanced']['name']; ?>
);'>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['parent_name_advanced']['options'],'selected' => $this->_tpl_vars['fields']['parent_type']['value']), $this);?>

</select>
<?php if (empty ( $this->_tpl_vars['fields']['parent_name_advanced']['options'][$this->_tpl_vars['fields']['parent_type']['value']] )): ?>
...
" class="sqsEnabled" tabindex="" size="" value="<?php echo $this->_tpl_vars['fields']['parent_name_advanced']['value']; ?>
...
" 
	   onclick='open_popup(document.search_form.parent_type.value, 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"parent_id","name":"parent_name_advanced"}}'; ?>
...
function parent_typechangeQS() {
	new_module = document.forms["search_form"].elements["parent_type"].value;
	if(typeof(disabledModules[new_module]) != 'undefined') {
		sqs_objects["search_form_<?php echo $this->_tpl_vars['fields']['parent_name_advanced']['name']; ?>
"]["disable"] = true;
		document.forms["search_form"].elements["<?php echo $this->_tpl_vars['fields']['parent_name_advanced']['name']; ?>
"].readOnly = true;
	} else {
		sqs_objects["search_form_<?php echo $this->_tpl_vars['fields']['parent_name_advanced']['name']; ?>
"]["disable"] = false;
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DIRECTION','module' => 'Calls'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('name' => 'direction_advanced[]','options' => $this->_tpl_vars['fields']['direction_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['direction_advanced']['value']), $this);?>

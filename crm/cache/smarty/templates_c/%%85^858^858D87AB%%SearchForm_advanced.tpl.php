<?php /* Smarty version 2.6.11, created on 2014-12-09 15:11:12
         compiled from cache/modules/Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 4, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 14, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 250, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 297, false),)), $this); ?>
...
' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_ADDRESS','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSTAL_CODE','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_COUNTRY','module' => 'Accounts'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Accounts'), $this);?>

		</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('name' => 'account_type_advanced[]','options' => $this->_tpl_vars['fields']['account_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['account_type_advanced']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_INDUSTRY','module' => 'Accounts'), $this);?>

		</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('name' => 'industry_advanced[]','options' => $this->_tpl_vars['fields']['industry_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['industry_advanced']['value']), $this);?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_parent_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_parent_name_advanced","parent_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["parent_id"],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_campaign_name_advanced\']={"form":"search_form","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_name_advanced","campaign_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_a__retorno__accounts_name_advanced\']={"form":"search_form","method":"query","modules":["A__Retorno_de_investimento"],"group":"or","field_list":["name","id"],"populate_list":["a__retorno__accounts_name_advanced","a__retorno7b64timento_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_opportuniti_accounts_name_advanced\']={"form":"search_form","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportuniti_accounts_name_advanced","opportunit9c8cunities_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};</script>'; ?>
<?php /* Smarty version 2.6.11, created on 2014-12-02 11:19:07
         compiled from cache/modules/ant_pedido/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ant_pedido/SearchForm_advanced.tpl', 4, false),array('function', 'math', 'cache/modules/ant_pedido/SearchForm_advanced.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/ant_pedido/SearchForm_advanced.tpl', 15, false),array('function', 'html_options', 'cache/modules/ant_pedido/SearchForm_advanced.tpl', 45, false),array('function', 'sugar_getimagepath', 'cache/modules/ant_pedido/SearchForm_advanced.tpl', 79, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['ped_codigo_boleto_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_codigo_boleto_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_codigo_boleto_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_codigo_boleto_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_codigo_boleto_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
...
<?php echo smarty_function_html_options(array('name' => 'ped_status_advanced[]','options' => $this->_tpl_vars['fields']['ped_status_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['ped_status_advanced']['value']), $this);?>
...
" value='<?php if (empty ( $_REQUEST['range_date_entered_advanced'] ) && ! empty ( $_REQUEST['date_entered_advanced'] )):  echo $_REQUEST['date_entered_advanced'];  else:  echo $_REQUEST['range_date_entered_advanced'];  endif; ?>' title=''  tabindex='' size="11" style="width:100px !important;">
...
_range_reset);
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_SEC_DESTINO','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_sec_destino_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_sec_destino_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_sec_destino_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_sec_destino_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_sec_destino_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_REG_DESTINO','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_reg_destino_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_reg_destino_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_reg_destino_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_reg_destino_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_reg_destino_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_CLIE_DESTINO','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_clie_destino_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_clie_destino_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_clie_destino_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_clie_destino_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_clie_destino_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_SEC_ORIGEM','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_sec_origem_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_sec_origem_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_sec_origem_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_sec_origem_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_sec_origem_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_REG_ORIGEM ','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_reg_origem_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_reg_origem_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_reg_origem_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_reg_origem_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_reg_origem_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PED_VALOR_TOTAL','module' => 'ant_pedido'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ped_valor_total_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ped_valor_total_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ped_valor_total_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ped_valor_total_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ped_valor_total_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};</script>'; ?>
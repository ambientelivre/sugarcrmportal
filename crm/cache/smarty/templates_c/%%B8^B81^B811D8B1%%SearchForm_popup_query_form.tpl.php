<?php /* Smarty version 2.6.11, created on 2015-02-13 11:24:54
         compiled from cache/modules/ant_produto/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ant_produto/SearchForm_popup_query_form.tpl', 4, false),array('function', 'math', 'cache/modules/ant_produto/SearchForm_popup_query_form.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/ant_produto/SearchForm_popup_query_form.tpl', 15, false),array('function', 'sugar_getimagepath', 'cache/modules/ant_produto/SearchForm_popup_query_form.tpl', 65, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['pd_nome_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['pd_nome_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['pd_nome_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pd_nome_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['pd_nome_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
...
<?php if (strlen ( $this->_tpl_vars['fields']['pd_descricao_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['pd_descricao_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['pd_descricao_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pd_descricao_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['pd_descricao_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 

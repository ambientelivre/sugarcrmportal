<?php /* Smarty version 2.6.11, created on 2012-03-25 20:09:13
         compiled from modules/Campaigns/WizardEmailSetup.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Campaigns/WizardEmailSetup.html', 182, false),)), $this); ?>
<!--
/*********************************************************************************
...
&nbsp;<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
				...
				<td ><input type='radio' onclick="change_state(this);" name='wiz_massemailer_tracking_entities_location_type' id='massemailer_tracking_entities_location_type' title="<?php echo $this->_tpl_vars['MOD']['LBL_DEFAULT_LOCATION']; ?>
...
&nbsp;<input type='radio' <?php echo $this->_tpl_vars['USERDEFINED_CHECKED']; ?>
 onclick="change_state(this);" name='wiz_massemailer_tracking_entities_location_type' id='massemailer_tracking_entities_location_type' title="<?php echo $this->_tpl_vars['MOD']['LBL_CUSTOM_LOCATION']; ?>

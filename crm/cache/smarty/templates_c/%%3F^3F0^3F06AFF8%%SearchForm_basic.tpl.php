<?php /* Smarty version 2.6.11, created on 2015-02-06 12:23:11
         compiled from cache/modules/ant_produto/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ant_produto/SearchForm_basic.tpl', 10, false),array('function', 'math', 'cache/modules/ant_produto/SearchForm_basic.tpl', 11, false),array('function', 'sugar_translate', 'cache/modules/ant_produto/SearchForm_basic.tpl', 21, false),array('function', 'sugar_getimagepath', 'cache/modules/ant_produto/SearchForm_basic.tpl', 77, false),array('modifier', 'count', 'cache/modules/ant_produto/SearchForm_basic.tpl', 64, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PD_NOME','module' => 'ant_produto'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['pd_nome_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['pd_nome_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['pd_nome_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pd_nome_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['pd_nome_basic']['name']; ?>
' size='30' 
    maxlength='255' 
...
' title='Nome' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PD_DESCRICAO','module' => 'ant_produto'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['pd_descricao_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['pd_descricao_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['pd_descricao_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pd_descricao_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['pd_descricao_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
...
</table><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_ant_itens_pt_produto_name_basic\']={"form":"search_form","method":"query","modules":["ant_itens_pedido"],"group":"or","field_list":["name","id"],"populate_list":["ant_itens_pt_produto_name_basic","ant_itens_d842_pedido_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_ant_log_estt_produto_name_basic\']={"form":"search_form","method":"query","modules":["ant_log_estoque"],"group":"or","field_list":["name","id"],"populate_list":["ant_log_estt_produto_name_basic","ant_log_es1933estoque_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_ant_producat_produto_name_basic\']={"form":"search_form","method":"query","modules":["ant_producao"],"group":"or","field_list":["name","id"],"populate_list":["ant_producat_produto_name_basic","ant_producf7ecroducao_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};sqs_objects[\'search_form_ant_estoquet_produto_name_basic\']={"form":"search_form","method":"query","modules":["ant_estoque_geral"],"group":"or","field_list":["name","id"],"populate_list":["ant_estoquet_produto_name_basic","ant_estoqu8380e_geral_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nada foi Encontrado"};</script>'; ?>
...
$mod_strings = array (
  ...
  'LBL_OOTB_CAMPAIGN' => 'Executar toda a noite o Envio em Massa de E-mail da Campanha',
  'LBL_OOTB_PRUNE' => 'Remover Apagados da Base de Dados no primeiro dia do Mês',
  'LBL_OOTB_TRACKER' => 'Remover apagados das tabelas de rastreador',
  ...
  'LBL_LIST_RANGE' => 'Data/Horario de Inicio:',
  ...
  'LBL_DATE_TIME_END' => 'Data e Hora do Fim',
  'LBL_DATE_TIME_START' => 'Data e Hora do Início',
  ...
  'LBL_NEVER' => 'Nunca',
  'LBL_NEW_FORM_TITLE' => 'Nova Tarefa no Agendador',
  ...
  'LBL_WARN_CURL' => 'Aviso:',
  'LBL_WARN_NO_CURL' => 'Este sistema não possui as bibliotecas cURL habilitadas/compiladas no módulo PHP (--with-curl=/path/to/curl_library).  Favor entre em contato com seu administrador de sistema para resolver esta questão.  Sem a funcionalidade cURL, o Agendador não pode executar as suas tarefas.',
  ...
  'LNK_NEW_SCHEDULER' => 'Nova Tarefa do Agendador',
  'LNK_LIST_SCHEDULED' => 'Tarefas Agendadas',
  'SOCK_GREETING' => 'Esta é a interface para o Serviço de Agendador do SugarCRM. ',
  'ERR_DELETE_RECORD' => 'Um número de Registro deve ser especificado para Excluir a Agendador.',
  'ERR_CRON_SYNTAX' => 'Sintaxe Cron inválida',
  'NTC_DELETE_CONFIRMATION' => 'Tem certeza que deseja Excluir este Registro?',
  'NTC_STATUS' => 'Configure o estado como Inativo para excluir este Agendador das listas de valores possíveis do Agendador',
  'NTC_LIST_ORDER' => 'Configure a ordem pela qual este Agendador aparecerá nas listas de valores possíveis do campo Agenda',
  ...
  'LBL_POLLMONITOREDINBOXESFORBOUNCEDCAMPAIGNEMAILS' => 'Executar toda a noite o Processamento de E-mails retornados das Campanhas',
  'LBL_PRUNEDATABASE' => 'Remover Apagados da Base de Dados no primeiro dia do Mês',
  'LBL_TRIMTRACKER' => 'Remover Apagados das Tabelas de Rastreador',
  'LBL_PROCESSWORKFLOW' => 'Processar Tarefas de Workflow',
  'LBL_PROCESSQUEUE' => 'Executar tarefas criadas de execução de relatórios',
  'LBL_UPDATETRACKERSESSIONS' => 'Atualizar Tabelas de Sessões de Rastreador',
);
?>

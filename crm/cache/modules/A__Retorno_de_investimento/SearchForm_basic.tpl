...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			{sugar_translate label='LBL_NAME' module='A__Retorno_de_investimento'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='A__Retorno_de_investimento'}
    	</td>

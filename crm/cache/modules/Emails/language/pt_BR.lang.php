...
$mod_strings = array (
  ...
  'LBL_SIGNATURE_PREPEND' => 'Assinatura acima <br>da resposta?',
  ...
  'LBL_QUOTE_LAYOUT_REGISTERED_ERROR' => 'layout da cotação não está registrado em modules/Cotações/Layouts.php',
  'LBL_CONFIRM_DELETE' => 'Tem certeza que pretende Excluir esta pasta?',
  ...
  'ERR_DELETE_RECORD' => 'Erro: Um número de Registro deverá ser especificado para Excluir a entidade.',
  ...
  'LBL_ADD_ANOTHER_FILE' => 'Adicionar Outro Arquivos',
  ...
  'LBL_EMAILS_NOTES_REL' => 'E-mails: Anotações ou Anexos',
  ...
  'LBL_RAW' => 'Email Geral',
  'LBL_SAVE_AS_DRAFT_BUTTON_LABEL' => 'Salvar como Rascunho',
  'LBL_SAVE_AS_DRAFT_BUTTON_TITLE' => 'Salvar como Rascunho [Alt+R]',
  ...
  'LBL_SEND_ANYWAYS' => 'Este e-mail está sem assunto. Enviar / Salvar mesmo assim?',
  ...
  'LNK_NEW_CALL' => 'Criar Nova Ligações',
  ...
  'LBL_LIST_TYPE' => 'Tipo',
  'NTC_REMOVE_INVITEE' => 'Tem certeza de que pretende Excluir este destinatário do e-mail?',
  ...
  'WARNING_UPLOAD_DIR_NOT_WRITABLE' => 'Os anexos podem falhar: Um valor incorreto ou não usual para o parâmetro "upload_tmp_dir" foi detectado. Por favor corrija o seu arquivo php.ini.',
  ...
  'LBL_USER_SELECT' => 'Selecionar Usuário',
  'LBL_USING_RULES' => 'Utilizando Perfis:',
  'LBL_WARN_NO_DIST' => 'Nenhum Método de Distribuição Selecionado',
  'LBL_WARN_NO_USERS' => 'Nenhum usuário está selecionado',
  'LBL_WARN_NO_USERS_OR_TEAM' => 'Por favor, selecione um usuário ou equipa para a atribuição.',
  ...
  'LBL_EMAIL_INBOUND_TYPE_HELP' => '<b>Pessoal:</b> conta de e-mail acessível por si. Só você pode gerir e importar e-mails dessa conta.<br> <b>Grupo:</b> conta de e-mail acessível a membros das equipas especificadas. Os membros das equipas podem gerir e importar e-mails dessa conta. <br><b>Grupo - Importação Automática:</b> a conta de e-mail acessível a membros de equipas especificadas. Emails são importados automaticamente como RegistrosRegistros.',
  ...
  'LBL_OF' => 'de',
  'LBL_TEST_EMAIL_BODY' => 'Este e-mail foi enviado para testar as definicoes do servidor de correio de saida fornecidas no Sugar. Uma recepcao bem-sucedida deste e-mail indica que as informacoes do servidor de correio de saida sao validas.',

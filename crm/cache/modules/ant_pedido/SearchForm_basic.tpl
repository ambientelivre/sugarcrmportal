...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_PED_CODIGO_BOLETO' module='ant_pedido'}
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.ped_codigo_boleto_basic.value) <= 0}
{assign var="value" value=$fields.ped_codigo_boleto_basic.default_value }
{else}
{assign var="value" value=$fields.ped_codigo_boleto_basic.value }
{/if}  
<input type='text' name='{$fields.ped_codigo_boleto_basic.name}' 
    id='{$fields.ped_codigo_boleto_basic.name}' size='30' 
    maxlength='255' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_DATE_ENTERED' module='ant_pedido'}
    	</td>
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_entered_basic) && !empty($smarty.request.date_entered_basic)}{$smarty.request.date_entered_basic}{else}{$smarty.request.range_date_entered_basic}{/if}' title=''  tabindex='' size="11" style="width:100px !important;">
...
{rdelim});
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_PED_STATUS ' module='ant_pedido'}
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options name='ped_status_basic[]' options=$fields.ped_status_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.ped_status_basic.value}
   	   	</td>

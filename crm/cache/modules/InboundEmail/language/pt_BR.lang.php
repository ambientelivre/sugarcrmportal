...
$mod_strings = array (
  ...
  'ERR_NO_OPTS_SAVED' => 'Nenhum otimizador foi gravados na sua Caixa de Entrada de E-mail. Por favor verifique as definições',
  ...
  'LBL_CREATE_NEW_GROUP' => '--Criar Grupo ao Salvars--',
  ...
  'LBL_MARK_READ_DESC' => 'Marcar mensagens como lidas no mail server ao importar; não Excluir.',
  ...
  'LBL_BOUNCE_MODULE_NAME' => 'Caixa de e-mail de tratamento de devoluções',
  ...
  'LBL_ONLY_SINCE_DESC' => 'Quando a utilizar POP3, o PHP não pode filtrar mensagens Novas/Não Lidas.  Esta opção permite verificar mensagens DESDE a última vez que a caixa de e-mail foi acedida.  Isto melhora significativamente a performance se o seu mail server não suporta IMAP.',
  ...
  'LBL_SAVE_RAW' => 'Salvar Fonte Não Tratada',
  ...
  'LBL_ASSIGN_TO_TEAM_DESC' => 'A equipe selecionada tem acesso à conta de e-mail. Se uma Pasta de Grupo é selecionada, a equipe atribuída à Pasta de Grupo sobrepõe-se à equipe selecionada.',
  'LBL_SSL' => 'Utilize SSL',
  'LBL_STATUS' => 'Status',
  ...
  'LBL_WARN_NO_IMAP' => 'Este sistema não possui as bibliotecas IMAP c-client ativadas/compiladas no módulo do PHP (--with-imap=/path/to/imap_c-client_library).  Por favor contate o seu administrador de sistema para resolver este problema.',
  'LNK_CREATE_GROUP' => 'Criar Novo Grupo',
  'LNK_LIST_CREATE_NEW_GROUP' => 'Nova conta de e-mail de grupo',
  'LNK_LIST_CREATE_NEW_BOUNCE' => 'Nova caixa de e-mail de tratamento de devolvidas',
  ...
  'LNK_SEED_QUEUES' => 'Semear Filas das equipes',
  ...
  'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'Quando esta opção estiver selecinada, o Nome e E-mail do Remetente associado a este grupo de e-mail irá aparecer com uma opção no campo Remetente quando estiver compondo e-mails para usuários com acesso a este grupo.',
  ...
  'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => 'Atenção: a importação automática tem que ser habilitada para a criação automática de Ocorrências.',
);
?>

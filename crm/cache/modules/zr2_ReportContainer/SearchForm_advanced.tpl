...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			{sugar_translate label='LBL_NAME' module='zr2_ReportContainer'}
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		{sugar_translate label='LBL_ASSIGNED_TO' module='zr2_ReportContainer'}
    	</td>
	<td  nowrap="nowrap" width='25%'>

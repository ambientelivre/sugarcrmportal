...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			{sugar_translate label='LBL_NAME' module='ant_log_estoque'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='ant_log_estoque'}
    	</td>

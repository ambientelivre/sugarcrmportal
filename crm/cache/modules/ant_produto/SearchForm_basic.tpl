...
{if strlen($fields.pd_nome_basic.value) <= 0}
{assign var="value" value=$fields.pd_nome_basic.default_value }
{else}
{assign var="value" value=$fields.pd_nome_basic.value }
{/if}  
<input type='text' name='{$fields.pd_nome_basic.name}' 
    id='{$fields.pd_nome_basic.name}' size='30' 
    maxlength='255' 
...
{if strlen($fields.pd_descricao_basic.value) <= 0}
{assign var="value" value=$fields.pd_descricao_basic.default_value }
{else}
{assign var="value" value=$fields.pd_descricao_basic.value }
{/if}  
<input type='text' name='{$fields.pd_descricao_basic.name}' 
    id='{$fields.pd_descricao_basic.name}' size='30' 
    maxlength='255' 

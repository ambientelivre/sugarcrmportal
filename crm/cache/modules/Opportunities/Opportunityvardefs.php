...
$GLOBALS["dictionary"]["Opportunity"] = array (
  ...
  array (
    ...
    array (
      ...
      'source' => 'non-db',
      'name' => 'lead_detail_c',
      'vname' => 'LBL_LEAD_DETAIL',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'comments' => 'Em caso de uma empresa cadastrada como conta referenciar a oportunidade, selecionar através deste campo qual a conta em questão',
      'help' => 'Selecione qual a conta que indicou a oportunidade.',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
    ...
    'source_employee_detail_c' => 
    array (
      'required' => false,
      'source' => 'non-db',
      'name' => 'source_employee_detail_c',
      'vname' => 'LBL_SOURCE_EMPLOYEE_DETAIL',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'comments' => '',
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiessource_employee_detail_c',
      'custom_module' => 'Opportunities',
    ),
    'contact_id_c' => 
    array (
    ...
    'contact_souce_detail_c' => 
    array (
      'required' => false,
      'source' => 'non-db',
      'name' => 'contact_souce_detail_c',
      'vname' => 'LBL_CONTACT_SOUCE_DETAIL',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'comments' => '',
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiescontact_souce_detail_c',
      'custom_module' => 'Opportunities',
    ),
    'site_source_detail_c' => 
    array (
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'site_source_detail_c',
      'vname' => 'LBL_SITE_SOURCE_DETAIL',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => 'http://',
      'comments' => '',
      'help' => 'Digite o endereço do site de onde veio a indicação',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Opportunitiessite_source_detail_c',
      'custom_module' => 'Opportunities',
    ),
    'tradeshow_source_detail_c' => 
    array (
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'tradeshow_source_detail_c',
      'vname' => 'LBL_TRADESHOW_SOURCE_DETAIL',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => NULL,
      'comments' => '',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Opportunitiestradeshow_source_detail_c',
      'custom_module' => 'Opportunities',
    ),
  ),
  'indices' => 

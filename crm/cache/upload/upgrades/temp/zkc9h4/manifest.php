 ...
 ********************************************************************************/
    ...
    $manifest = array (
         'acceptable_sugar_versions' => 
          ...
          'name' => 'antigenos',
          'published_date' => '2014-12-09 17:48:25',
          'type' => 'module',
          'version' => '1418147305',
...
$installdefs = array (
  ...
  array (
    ...
    2 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_secretarias_ant_regionais_ant_regionais.php',
      'to_module' => 'ant_regionais',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_inutilizado_ant_itens_inutilizados_ant_itens_inutilizados.php',
      'to_module' => 'ant_itens_inutilizados',
    ),
    4 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_inutilizado_ant_itens_inutilizados_ant_inutilizado.php',
    ...
    8 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_pedido_ant_lista_pedidos_ant_lista_pedidos.php',
    ...
    10 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_pedido_ant_regionais_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
    11 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/ant_pedido_ant_regionais_1_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
  ),
  'relationships' => 
  array (
    ...
    10 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/ant_inutilizado_ant_itens_inutilizadosMetaData.php',
    ),
    11 => 
    array (
    ...
    16 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/ant_pedido_ant_regionaisMetaData.php',
    ),
    17 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/ant_pedido_ant_regionais_1MetaData.php',
    ),
    18 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/ant_pedido_ant_secretariasMetaData.php',
    ),
    19 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/ant_pedido_ant_secretarias_1MetaData.php',
    ),
  ),
  ...
  array (
    ...
    20 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_inutilizado_ant_itens_inutilizados_ant_itens_inutilizados.php',
      'to_module' => 'ant_itens_inutilizados',
    ),
    21 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_inutilizado_ant_itens_inutilizados_ant_inutilizado.php',
      'to_module' => 'ant_inutilizado',
    ),
    22 => 
    array (
    ...
    32 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_regionais_ant_regionais.php',
      'to_module' => 'ant_regionais',
    ),
    33 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_regionais_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
    34 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_regionais_1_ant_regionais.php',
      'to_module' => 'ant_regionais',
    ),
    35 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_regionais_1_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
    36 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_secretarias_ant_secretarias.php',
      'to_module' => 'ant_secretarias',
    ),
    37 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_secretarias_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
    38 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_secretarias_1_ant_secretarias.php',
      'to_module' => 'ant_secretarias',
    ),
    39 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/ant_pedido_ant_secretarias_1_ant_pedido.php',
      'to_module' => 'ant_pedido',
    ),
  ),
  'layoutfields' => 
